...
// 병목 점수 가중치
//   embeds  : 안긴절 수 (관형절·명사절·부사절·인용절)
//   nominal : 명사화 수 (용언을 명사로 압축)
//   passive : 피동 표현 수 ('-되다', '-어지다' 등)
//   density : 문장당 절 밀도 (절 수 ÷ 문장 수)
...
const passages = [
  ...
  },
  {
    ...
    questions: [
      { id: 'O1', type: 'recall', sourceUnit: 1,
        text: '삼투에서 반투막을 통과하는 것은 무엇인가?',
        options: ['용질', '용매', '용질과 용매 모두', '아무것도 통과 못 함'], answer: 1 },
      { id: 'O2', type: 'recall', sourceUnit: 3,
        text: '삼투압이란 무엇인가?',
        options: ['용매가 저절로 이동하는 힘', '용매의 이동을 막기 위해 고농도 쪽에 가하는 압력', '용질이 막을 통과하는 압력', '온도가 높아질 때 생기는 압력'], answer: 1 },
      { id: 'O3', type: 'integration', sourceUnit: 2,
        text: '삼투에서 용매가 이동하는 방향으로 옳은 것은?',
        options: ['고농도 → 저농도', '저농도 → 고농도', '양쪽으로 똑같이', '이동하지 않는다'], answer: 1 },
      { id: 'O4', type: 'integration', sourceUnit: 4,
        text: '용액에 녹은 용질 입자 수가 많아지면 삼투압은 어떻게 되는가?',
        options: ['작아진다', '변화 없다', '비례하여 커진다', '반비례하여 작아진다'], answer: 2 },
      { id: 'O5', type: 'inference', sourceUnit: 5,
      ...
      { id: 'O6', type: 'inference', sourceUnit: 2,
        text: '농도가 다른 두 용액을 반투막으로 오래 두면 결국 어떤 상태가 되는가?',
        options: ['한쪽 농도가 계속 높아진다', '양쪽 농도 차이가 줄어든다', '용질이 막을 넘어간다', '아무 변화도 없다'], answer: 1 },
    ],
  },
];
